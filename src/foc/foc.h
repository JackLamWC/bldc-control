...
#define FOC_CURRENT_GET_CURRENT_F(CSH) ((CSH - FOC_CURRENT_SENSING_VOLTAGE_OFFSET) / (FOC_CURRENT_SENSING_R_SENSE * FOC_CURRENT_SENSING_GAIN))

#include "ch.h"

// Function pointer types for hardware abstraction
typedef void (*foc_get_currents_func_t)(uint16_t *ia, uint16_t *ib, uint16_t *ic);
